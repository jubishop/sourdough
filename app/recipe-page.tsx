...
const steps = [
  ...
  },
  {
    ...
    body: 'Leave the dough covered and undisturbed in the proofing container. Aim for 1.35 L where the dough meets the glass. Fermentation will make the center noticeably higher. The dough should look puffy and rounded, with bubbles at the edges and a gentle jiggle when you move the container. Then shape and place it in the banneton.',
        ...
        <section className="schedule-overview" aria-labelledby="schedule-title">
          ...
          <ol className="schedule-list">
            ...
            <li>
              ...
              <p>Mix the salt and levain, then do the first stretch and fold immediately. Repeat as needed in Step 4, waiting at least 15 minutes between sets and covering the mixing bowl between repeats. Rub a very light film of oil over the inside of the proofing container to help the dough release easily later. After the last fold, transfer the dough to the container, cover, and leave undisturbed. Aim for 1.35 L at the glass edge, using the visual cues in Step 5.</p>
            </li>
            <li>
              <h3>Shape</h3>
