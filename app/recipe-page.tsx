...
const steps = [
  ...
  },
  {
    ...
    body: 'Do the first stretch and fold 15 minutes after mixing in the salt and levain. Then repeat as needed, waiting at least 25 minutes between rounds. Do no more than six rounds total.',
