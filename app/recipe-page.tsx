...
const steps = [
  ...
  },
  {
    ...
    icon: Flame,
    title: 'Finish uncovered at 430°F',
    body: 'Remove the lid, lower the oven to 430°F, and bake for 26 minutes. The uncovered bake lets the crust dry and brown. Then remove the loaf from the oven.',
  },
  {
    id: 'cool',
    phase: 'Finish',
