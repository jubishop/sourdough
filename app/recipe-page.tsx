...
const steps = [
  ...
  },
  {
    ...
    icon: RotateCcw,
    title: 'Stretch and fold up to 5 times',
    body: 'Do the first stretch and fold immediately after mixing in the salt and levain. Then repeat every 30 minutes up to 4 more times, for 5 total. You can stop after the first or any later repeat.',
        ...
        <section className="schedule-overview" aria-labelledby="schedule-title">
          ...
          <ol className="schedule-list">
            ...
            <li>
              ...
              <p>Mix the salt and levain, then do the first stretch and fold immediately. Repeat every 30 minutes up to 4 more times in Step 4, covering the mixing bowl between repeats. After the last one, transfer to the proofing container, cover, and leave undisturbed. Aim for 1.2 quarts, using the visual cues in Step 5.</p>
            </li>
            <li>
              <h3>Shape</h3>
