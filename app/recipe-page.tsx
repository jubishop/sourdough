        ...
        <section className="schedule-overview" aria-labelledby="schedule-title">
          ...
          <ol className="schedule-list">
            ...
            <li>
              ...
              <p>Mix the salt and levain, then do the first stretch and fold immediately. Repeat every 30 minutes as needed in Step 4, covering the mixing bowl between repeats. After the last one, transfer to the proofing container, cover, and leave undisturbed. Aim for 1.2 quarts, using the visual cues in Step 5.</p>
            </li>
            <li>
              <h3>Shape</h3>
