...
const steps = [
  ...
  },
  {
    ...
    icon: RotateCcw,
    title: 'Bench stretch and fold up to 5 times',
    body: 'Do the first bench stretch and fold immediately after mixing in the salt and levain. Then repeat every 30 minutes up to 4 more times, for 5 total. You can stop after the first or any later repeat.',
    cue: 'Keep the dough covered in the mixing bowl between repeats. After your last bench stretch and fold, gently transfer the dough to your 2-quart proofing container and cover it.',
  },
  {
    id: 'bulk',
  ...
  },
  {
    ...
    body: 'Place a foil pad about ¼ inch thick in the bottom of the Dutch oven. Then preheat it with the pizza stone at 475°F for at least 60 minutes.',
    details: [
        ...
        <section className="schedule-overview" aria-labelledby="schedule-title">
          ...
          <ol className="schedule-list">
            ...
            <li>
              ...
              <p>Mix the salt and levain, then do the first bench stretch and fold immediately. Repeat every 30 minutes up to 4 more times in Step 4, covering the mixing bowl between repeats. After the last one, transfer to the proofing container, cover, and leave undisturbed. Aim for 1.2 quarts, using the visual cues in Step 5.</p>
            </li>
            <li>
              <h3>Shape</h3>
            ...
            <li>
              ...
              <p>Place a foil pad about ¼ inch thick in the bottom of the Dutch oven. Then preheat it with the pizza stone at 475°F for at least the final 60 minutes.</p>
            </li>
            <li>
              <h3>Bake</h3>
